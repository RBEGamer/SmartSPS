...
struct  X509Store_t1147  : public Object_t
{
	...
	X509Certificate2Collection_t1141 * ___list_2;
	...
	X509Store_t868 * ___store_4;
};
struct X509Store_t1147_StaticFields{
	...
	Dictionary_2_t202 * ___U3CU3Ef__switchU24mapF_5;
};
