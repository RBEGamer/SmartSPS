...
struct  SslStreamBase_t750  : public Stream_t739
{
	// System.IO.Stream Mono.Security.Protocol.Tls.SslStreamBase::innerStream
	Stream_t739 * ___innerStream_3;
	...
	RecordProtocol_t722 * ___protocol_6;
