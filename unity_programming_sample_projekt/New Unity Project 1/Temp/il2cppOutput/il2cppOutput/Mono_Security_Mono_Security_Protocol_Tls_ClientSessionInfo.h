...
struct  ClientSessionInfo_t895  : public Object_t
{
	...
	ByteU5BU5D_t444* ___sid_4;
	// System.Byte[] Mono.Security.Protocol.Tls.ClientSessionInfo::masterSecret
	ByteU5BU5D_t444* ___masterSecret_5;
};
struct ClientSessionInfo_t895_StaticFields{
