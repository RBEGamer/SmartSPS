...
struct  ExtendedKeyUsageExtension_t701  : public X509Extension_t695
{
	// System.Collections.ArrayList Mono.Security.X509.Extensions.ExtendedKeyUsageExtension::keyPurpose
	ArrayList_t660 * ___keyPurpose_3;
};
struct ExtendedKeyUsageExtension_t701_StaticFields{
	...
	Dictionary_2_t198 * ___U3CU3Ef__switchU24map14_4;
};
