...
struct  SimpleCollator_t1320  : public Object_t
{
	...
	CodePointIndexer_t1306 * ___cjkIndexer_6;
	...
	CodePointIndexer_t1306 * ___cjkLv2Indexer_8;
...
struct SimpleCollator_t1320_StaticFields{
	...
	SimpleCollator_t1320 * ___invariant_1;
};
